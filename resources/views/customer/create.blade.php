            ...
            <form method="post" enctype="multipart/form-data" action="{{url('admin/customer')}}">
                ...
                <table class="table table-bordered">
                    <tr>
                        <th>Full Name</th>
                        <td>
                            <input name="full_name" placeholder="Full name" type="text" class="form-control">
                            @error('full_name')
                ...
                <tr>
                    <th>Email</th>
                    <td><input name="email" placeholder="email" type="email" class="form-control">
                        @error('email')
                    <p class="text-danger">{{$message}}</p> 
                 @enderror</td>
                ...
                <tr>
                    <th>Mobile</th>
                    <td><input name="mobile" placeholder="mobile" type="mobile" class="form-control">
                        @error('mobile')
                    <p class="text-danger">{{$message}}</p> 
                 @enderror</td>
                ...
                <tr>
                    <th>Address</th>
                    <td><textarea name="address" placeholder="Address" type="address" class="form-control"></textarea> @error('address')
                        <p class="text-danger">{{$message}}</p> 
                     @enderror  
                     </td>
                </tr>
